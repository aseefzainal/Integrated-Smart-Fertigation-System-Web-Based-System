<div class="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 md:h-[26.3rem] shadow-lg">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        {{-- data-modal-toggle="addScheduleModal" wire:click="$set('showCrudScheduleModal', false)"> --}}
                        data-modal-toggle="addScheduleModal" wire:click="closeCrudModal">
