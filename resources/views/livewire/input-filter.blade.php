<div
    ...
    @if (session('success'))
        ...
        <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
            ...
            class="absolute top-3 right-3 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
            role="alert">
            <div
    ...
    <div x-data="{ showModal: false }" x-show="showModal" id="deleteModal" tabindex="-1" aria-hidden="true"
        ...
        style="display: none;" x-show="showModal">
