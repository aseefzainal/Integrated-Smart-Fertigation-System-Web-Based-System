        ...
        <div class="sm:w-3/4 mx-auto p-4 sm:p-10">
            ...
            @if ($tab === 5)
                <div class="grid gap-4 sm:grid-cols-3 sm:gap-4">
                    ...
                    @empty
                        <div
                            class="sm:col-span-3 h-80 bg-slate-50 border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 mb-4 mt-3 flex flex-col justify-center items-center">
