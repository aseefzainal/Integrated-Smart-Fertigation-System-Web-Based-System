<div>
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4 w-full text-gray-900 font-medium text-sm ">
        <div wire:click="$set('tab', 1)"
            class="rounded-lg bg-white p-4 shadow-md cursor-pointer hover:bg-slate-50 border-[1px] border-gray-200 dark:border-gray-600">
            <h4 class="mb-3 text-gray-500">Number of Users</h4>
        ...
        <div wire:click="$set('tab', 2)"
            class="rounded-lg bg-white p-4 shadow-md cursor-pointer hover:bg-slate-50 border-[1px] border-gray-200 dark:border-gray-600">
            <h4 class="mb-3 text-gray-500">Number of Projects</h4>
            <div class="flex items-center">
                <div class="p-2 rounded-full border-[1px] border-gray-300 bg-slate-50 mr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-4">
        ...
        <div wire:click="$set('tab', 3)"
            class="rounded-lg bg-white p-4 shadow-md cursor-pointer hover:bg-slate-50 border-[1px] border-gray-200 dark:border-gray-600">
            <h4 class="mb-3 text-gray-500">Total Orders</h4>
            <div class="flex items-center">
                <div class="p-2 rounded-full border-[1px] border-gray-300 bg-slate-50 mr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-4">
        ...
        <div wire:click="$set('tab', 4)"
            class="rounded-lg bg-white p-4 shadow-md cursor-pointer hover:bg-slate-50 border-[1px] border-gray-200 dark:border-gray-600">
            <h4 class="mb-3 text-gray-500">Outstanding Notification Costs</h4>
            <div class="flex items-center">
                <div class="p-2 rounded-full border-[1px] border-gray-300 bg-slate-50 mr-2">
                    {{-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-8.69-6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
                ...
                <span class="text-2xl">RM150.00</span>
            </div>
        </div>
    </div>
