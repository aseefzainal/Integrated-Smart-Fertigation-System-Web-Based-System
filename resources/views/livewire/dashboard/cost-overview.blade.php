<div class="grid grid-cols-4 gap-3 mb-4">
    <div
        class="col-span-3 rounded-lg border-[1px] border-gray-200 dark:border-gray-600 bg-white p-4 shadow-md space-y-2">
        ...
        <div class="flex justify-between items-center">
            <div class="space-y-1">
                ...
                <div class="flex items-center space-x-1">
                    <span class="text-xl">RM100.00</span>
            ...
            <div class="flex space-x-4">
                <div class="flex items-center">
                    ...
                    <span class="text-sm ml-2">Pending Payment</span>
                </div>
                <div class="flex items-center">
                    <div class="size-3 rounded-full bg-red-500"></div>
                    <span class="text-sm ml-2">Payment Received</span>
                </div>
            </div>
        </div>
        <div class="w-full">
            ...
            @foreach ($users as $user)
                <div class="flex justify-between items-center px-4 py-2 cursor-pointer hover:bg-slate-100">
                    ...
                    <div>
                        ...
                        <span class="text-sm">RM200.00</span>
                    </div>
                </div>
            @endforeach
        </div>
