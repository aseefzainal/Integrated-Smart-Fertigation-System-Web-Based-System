                                        ...
                                        @foreach ($users as $user)
                                            <tr class="border-b dark:border-gray-700">
                                                ...
                                                <th scope="row"
                                                    ...
                                                    {{ $user->title . ' ' . implode(' ', array_slice(preg_split('/\s+/', $user->name), 0, 3)) }}</th>
                                                <td class="px-4 py-3">{{ $user->phone }}</td>
                                                <td class="px-4 py-3">Active</td>
                                                <td class="px-4 py-3">{{ $user->email }}</td>
                                                <td class="px-4 py-3">{{ Str::limit(optional($user->address)->address_line_1 . ' ' . optional($user->address)->address_line_2 . ' ' . optional($user->address)->postcode . ' ' . optional($user->address)->city . ' ' . optional($user->address)->state, 50, '...') }}</td>
